...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.0.21-blue?style=flat-square" alt="Version" />
...
```bash
curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.21/install.sh -o install.sh
...
```bash
wget https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.21/install.sh
bash install.sh
```
...
less install.sh
MAPICK_VERSION=v0.0.21 bash install.sh
