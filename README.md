...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.0.18-blue?style=flat-square" alt="Version" />
...
```bash
wget https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.18/install.sh
bash install.sh
```
...
less install.sh
MAPICK_VERSION=v0.0.18 bash install.sh
