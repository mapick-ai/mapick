...
```bash
curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.1/install.sh | bash
```

Or with `wget`:

```bash
wget -qO- https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.1/install.sh | bash
```

Pin a specific version:

```bash
MAPICK_VERSION=v0.0.1 bash -c "$(curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapick/main/install.sh)"
```
