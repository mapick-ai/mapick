...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.0.9-blue?style=flat-square" alt="Version" />
...
```bash
wget https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.9/install.sh
bash install.sh
```
