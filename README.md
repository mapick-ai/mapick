...
<p align="center">
  <img src="https://img.shields.io/badge/version-v1.0.16-blue?style=flat-square" alt="Version" />
...
```bash
curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapick/v1.0.15/install.sh -o install.sh
...
```bash
wget https://raw.githubusercontent.com/mapick-ai/mapick/v1.0.15/install.sh
bash install.sh
```
...
less install.sh
MAPICK_VERSION=v1.0.15 bash install.sh
