...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.0.2-blue?style=flat-square" alt="Version" />
...
```bash
curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.2/install.sh | bash
```

Or with `wget`:

```bash
wget -qO- https://raw.githubusercontent.com/mapick-ai/mapick/v0.0.2/install.sh | bash
```

Pin a specific version:

```bash
MAPICK_VERSION=v0.0.2 bash -c "$(curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapick/main/install.sh)"
```
