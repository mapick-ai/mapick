...
<p align="center">
  <img src="https://img.shields.io/badge/version-v0.0.5-blue?style=flat-square" alt="Version" />
...
```bash
MAPICK_VERSION=v0.0.5 bash -c "$(curl -fsSL https://raw.githubusercontent.com/mapick-ai/mapick/main/install.sh)"
```
